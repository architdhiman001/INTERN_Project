...
const ReportFound = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      navigate("/founditems"); // Redirect to all found items after submission
    }
  };
  ...
  return (
    <div className="bg-[#393E46] min-h-screen text-[#DFD0B8] p-6 pt-20">
      <div className="max-w-3xl mx-auto bg-[#222831] border border-[#DFD0B8] rounded-lg p-8">
        <h1 className="text-2xl font-bold mb-6 text-[#DFD0B8]">Report a Found Item</h1>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end mt-4">
            <button type="submit" className="bg-yellow-400 text-[#393E46] px-6 py-2 rounded-md font-semibold">
              Submit Report
            </button>
          </div>
        </form>
