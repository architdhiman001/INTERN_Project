    ...
    <nav className="bg-[#222831]/50 backdrop-blur-md text-[#DFD0B8] w-full fixed top-0 flex items-center h-16 shadow-lg z-50 transition-all duration-500">
      <div className="container mx-auto flex justify-between items-center px-6">
        ...
        <div className='flex space-x-8 text-lg items-center'>
          <Link className='hover:text-[#e8e8e8] transition-colors duration-300' to='/'>Home</Link>
          <Link className='hover:text-[#e8e8e8] transition-colors duration-300' to='/lostitems'>Lost Items</Link>
          <Link className='hover:text-[#e8e8e8] transition-colors duration-300' to='/founditems'>Found Items</Link>

          {username ? (
            <div className='flex items-center gap-4'>
              <span className='text-[#F6C90E] font-semibold'>{username}</span>
              <button
            ...
            <Link className='hover:text-[#e8e8e8] transition-colors duration-300' to='/login'>Login</Link>
          )}
        </div>
      </div>
    </nav>
